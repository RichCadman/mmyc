		...
		<ul>
			...
			<li class="fgs_l_li">
				<a href="/index.php/Qyzx/fgs.html">各分公司</a>
					...
					<div class="fgs_r">
						<ul>
							<?php if(is_array($geju)): foreach($geju as $key=>$v): ?><li class="fgs_r_li">
								<div class="fgs_r_li_l">
									<img src="/pub/upload/<?php echo ($v["img"]); ?>"/>
								</div>
								<div class="fgs_r_li_r">
									<div class="fgs_r_h1">
										<a href="/index.php/Qyzx/geju1/id/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a> 
									</div>
									<div class="fgs_r_c1">
										发布时间：<?php echo date("Y-m-d",$v['time']);?>
									</div>
									<div class="fgs_r_c_sm">
										<a href="/index.php/Qyzx/geju1/id/<?php echo ($v["id"]); ?>"><?php echo ($v["content"]); ?></a>
									</div>
								</div>
