...
<html>
	...
	<body>
		...
		<div class="cp_herf">
			<a href="#">Home</a> > <a href="#">Product Center</a> > <?php echo ($info["title1"]); ?>
		</div>
		<div class="cpny_bt whidden">
			<span><?php echo ($info["title1"]); ?></span>
		</div>
		<div class="cpny_bthd">
			<span><?php echo ($info["title1"]); ?> </span>
		</div>
		...
		<div class="cp_text">
			<?php if($info['content1']!=''): ?>&emsp;&emsp;<?php echo ($info["content3"]); endif; ?>
			<?php if($info['mmtm_img2']!=''): ?><br /><img src="/pub/upload/<?php echo ($info["mmtm_img2"]); ?>"/><?php endif; ?>
			<?php if($info['content2']!=''): ?><br />&emsp;&emsp;<?php echo ($info["content4"]); endif; ?>
		</div>
