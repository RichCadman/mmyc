...
<html>
	...
	<body>
		...
		<div class="cp_herf">
			<a href="#">首页</a> > <a href="#">新闻中心</a> > <?php echo ($info["title"]); ?>
		</div>
		<div class="cpny_bt">
			<?php echo ($info["title"]); ?>
		</div>
		...
		<div class="news_time">
			发布时间:<?php echo date("Y-m-d",$info['release_time']);?>
		</div>
		<div class="cp_text">
			<?php if($info['content1']!=''): ?><br />&emsp;&emsp;<?php echo ($info["content1"]); endif; ?>

			
			<?php if($info['news_img1']!=''): ?><br />
			<img src="/pub/upload/<?php echo ($info["news_img1"]); ?>"/><?php endif; ?>

			<?php if($info['content2']!=''): ?><br />&emsp;&emsp;<?php echo ($info["content2"]); endif; ?>
			

			<?php if($info['news_img2']!=''): ?><br />
			<img src="/pub/upload/<?php echo ($info["news_img2"]); ?>"/><?php endif; ?>

			<?php if($info['content3']!=''): ?><br />&emsp;&emsp;<?php echo ($info["content3"]); endif; ?>

			

			<?php if($info['news_img3']!=''): ?><br />
			<img src="/pub/upload/<?php echo ($info["news_img3"]); ?>"/><?php endif; ?>

			<?php if($info['content4']!=''): ?><br />&emsp;&emsp;<?php echo ($info["content4"]); endif; ?>

			

			<?php if($info['news_img4']!=''): ?><br />
			<img src="/pub/upload/<?php echo ($info["news_img4"]); ?>"/><?php endif; ?>
