...
<html>
	...
	<body>
		...
		<div class="ny_con">
			...
			<div class="ny_c">
				<div class="ny_c_h">
					<span>VENEER </span><i>/ Veneer</i>
				</div>
				<div class="ny_c_c">
					&emsp;&emsp;Shenzhen Meiming Dental Equipment Co. Ltd is a leading supplier of denture, focusing on the ciya field, adhere to sound management and continuous innovation, openness and cooperation, providing high-quality teeth and cost-effective solution for outpatient. Established in 2005, the company is headquartered in Shenzhen and has set up branch offices in Shandong, Shanxi, Inner Mongolia, Hunan, Sichuan, Shaanxi and Shenzhen. At present, the company has grown into the largest high-end denture manufacturer in the north and is equipped with an international denture processing equipment. The company has a number of high-end denture brands, including "beauty Ming" and "Luo poetry" has been a well-known brand in the industry. Advanced and sophisticated marketing model has achieved great success, the company will seize the industry in the next 5 years wave tide, the national market development strategy layout, do a solid industry leader.
				</div>
				<ul class="fgs_ul">
					<li class="fgs_li">
						<img src="/pub/home/img/ny1.jpg"/>
						<div class="fgs_li_c">
							<span>Company vision</span><i>：Let the world have no ugly teeth</i>
						</div>
					</li>
					<li class="fgs_li">
						<img src="/pub/home/img/ny2.jpg"/>
						<div class="fgs_li_c">
							<span>Company mission</span><i>：Dedicated to becoming the first comprehensive solution provider in the dental industry </i>
						</div>
					</li>
					<li class="fgs_li">
						<img src="/pub/home/img/ny3.jpg"/>
						<div class="fgs_li_c">
							<span>Enterprise spirit</span><i>：Down-to-earth and steady innovation</i>
						</div>
					</li>
				</ul>
				<div class="fgs">
		...
		<ul>
			<li class="fgs_l_li">
				<a href="/index.php/QyzxE/index.html">Contact us</a>
			</li>
			<li class="fgs_l_li">
				<a href="/index.php/QyzxE/geju.html">Veneer under national pattern</a>
			</li>
			<li class="fgs_l_li">
				<a href="/index.php/QyzxE/school.html">MeiMing Business School</a>
			</li>
			<li class="fgs_l_li">
				<a href="/index.php/QyzxE/change.html">Job opportunities and career development</a>
			</li>
			<li class="fgs_l_li">
				<a href="/index.php/QyzxE/network.html">MeiMing National network</a>
			</li>
			<li class="fgs_l_li">
				<a href="/index.php/QyzxE/fgs.html">All branches</a>
			</li>
		</ul>
	</div>
					<div class="fgs_r">
						<ul>
							<?php if(is_array($change)): foreach($change as $key=>$v): ?><li class="fgs_r_li">
								<div class="fgs_r_li_l">
									<img src="/pub/upload/<?php echo ($v["img"]); ?>"/>
								</div>
								<div class="fgs_r_li_r">
									<div class="fgs_r_h">
										<a href="/index.php/QyzxE/change1/id/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a>  
									</div>
									<div class="fgs_r_c">
										<a href="/index.php/QyzxE/change1/id/<?php echo ($v["id"]); ?>"><?php echo ($v["content"]); ?></a>
									</div>
								</div>
						...
						<div class="ny_herf">
							<div class="ny_herf_l">
								...
								><a href="#">next page</a
								><a href="#">Shadowe</a
								><span class="whidden">Page: 1/1 page</span><span>共12条记录</span><span class="whidden">15条每页</span>
							</div>
							<div class="ny_herf_r">
