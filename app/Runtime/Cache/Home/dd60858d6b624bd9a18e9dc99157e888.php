...
<html>
	...
	<body>
		...
		<div class="news">
			<ul class="news_c">
				<li class="news_c_li"><a href="#">Dynamic</a></li>
				<li class="news_c_li"><a href="#">Recommend</a></li>
			</ul>
		</div>
		<div class="bt1 whidden">
			<span>Dynamic </span><em>/ Dynamic</em>
		</div>
		<div class="cpny_bthd">
			<span>News </span>
		</div>
				...
				<?php if(is_array($news_two)): foreach($news_two as $key=>$v): ?><div class="news_con_r_li">
					...
					<div class="news_crl_r">
						<div class="news_crl_h">
							<a href="/index.php/XwzxE/index1/id/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a>
						</div>
						<div class="news_crl_c">
							<a href="/index.php/XwzxE/index1/id/<?php echo ($v["id"]); ?>"><?php echo ($v["content1"]); ?></a>
						</div>
					</div>
