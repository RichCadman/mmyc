			...
			<div class="login_con1">
				<div class="login_con1_c">
					...
					<div class="login_email">
						登录账号为您注册的邮箱<span><?php echo ($email); ?></span>
					</div>
					<form action="/index.php/Login/login" method="post" class="login_form1">
						<input type="submit" value="开始使用" class="login_sub login_sub1"/>
					</form>
