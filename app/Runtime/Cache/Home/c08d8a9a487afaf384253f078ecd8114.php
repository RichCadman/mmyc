	...
	<body>
		...
		<div class="ny_con">
			...
			<div class="ny_c">
				...
				<div class="ny_c_c">
					&emsp;&emsp;Shenzhen Meiming Dental Equipment Co. Ltd is a leading supplier of denture, focusing on the ciya field, adhere to sound management and continuous innovation, openness and cooperation, providing high-quality teeth and cost-effective solution for outpatient. The company was founded in 2005
Headquartered in Shenzhen in 2000, we have set up branch offices in Shandong, Shanxi, Inner Mongolia, Hunan, Sichuan, Shaanxi and Shenzhen. At present, the company has grown into the largest high-end denture manufacturer in the north and is equipped with an international denture processing equipment. Company flag
Under a number of high-end denture brands, of which "beauty Ming" and "Luo poetry" has been well-known brands in the industry. The advanced and mature marketing model has achieved great success. The company will seize the wave of the industry tuyere in the next 5 years, and carry out the strategic layout of the national market development, and make a solid line
Industry leader.
				</div>
				<ul class="fgs_ul">
					<li class="fgs_li">
				...
				<a href="/index.php/QyzxE/fgs.html">All branches</a>
					...
					<div class="fgs_r">
						<ul>
							...
							<?php if(is_array($fgs)): foreach($fgs as $key=>$v): ?><li class="fgs_r_li">
								...
								<div class="fgs_r_li_r">
									...
									<div class="fgs_r_c">
										Address：<?php echo ($v["address"]); ?>
										<br />Telephone：<?php echo ($v["tel"]); ?>
										<br />Q Q : <?php echo ($v["qq"]); ?>
									</div>
								</div>
