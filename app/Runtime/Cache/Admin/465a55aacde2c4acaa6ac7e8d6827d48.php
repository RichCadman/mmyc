...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">上传视频</a> </div>
  <h1>上传视频</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Khzq/update/id/<?php echo ($video["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">

            
             <div class="control-group">
              <label class="control-label">标题 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($video["title"]); ?>" name="title" id="title" />
              </div>
            </div>
            ...
            <div class="controls">
              <textarea class="textarea_editor span12" name="content" id="content1" rows="17" placeholder="输入文字..."></textarea>
            </div> -->
