        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($phone)): foreach($phone as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  <td><?php echo ($v["phone"]); ?></td>
                  <?php if($v['type']==1): ?><td>手机端</td>
                  <?php elseif($v['type']==2): ?>
                  <td>电脑端</td>
                  <?php elseif($v['type']==3): ?>
                  <td>手机端QQ</td>
                  <?php elseif($v['type']==4): ?>
                  <td>分享QQ、微博内容</td><?php endif; ?>

                  <td><a href="/admin.php/Company/mod_phone/id/<?php echo ($v["id"]); ?>">修改</a></td>
