    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Company/mod2/id/<?php echo ($share["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="controls">
              <textarea class="textarea_editor span12" name="content" id="content1" rows="17" placeholder="输入文字..."><?php echo ($share["content"]); ?></textarea>
            </div>
