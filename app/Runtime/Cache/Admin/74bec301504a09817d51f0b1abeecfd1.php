...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">上传美鸣产品系列图片</a> </div>
  <h1>上传美鸣产品系列图片</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Indexs/update2/id/<?php echo ($xl["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">

            <div class="control-group">
              <div class="control-group">
                <label class="control-label">标题 :</label>
                <div class="controls">
                  <input type="text" class="span11" value="<?php echo ($xl["title"]); ?>" name="title" id="title" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">标题(英文) :</label>
                <div class="controls">
                  <input type="text" class="span11" value="<?php echo ($xl["title1"]); ?>" name="title1" id="title" />
                </div>
              </div>
            <div class="control-group">
              <label class="control-label">上传图片</label>
              <div class="controls">
                <input type="file" name="mmtm_img[]" id="files"/>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="file" name="mmtm_img[]" id="files1"/>
              </div>
            </div>
            ...
            <label class="control-label">文章内容（图片上）</label>
            <div class="controls">
              <textarea class="textarea_editor span12" name="content1" id="content1" rows="17" placeholder="输入文字..."><?php echo ($xl["content1"]); ?></textarea>
            </div>

            <label class="control-label">文章内容（图片下）</label>
            <div class="controls">
              <textarea class="textarea_editor1 span12" name="content2" id="content2" rows="17" placeholder="输入文字..."><?php echo ($xl["content2"]); ?></textarea>
            </div>

            <label class="control-label">英文文章内容（图片上）</label>
            <div class="controls">
              <textarea class="textarea_editor2 span12" name="content3" id="content1" rows="17" placeholder="输入文字..."><?php echo ($xl["content3"]); ?></textarea>
            </div>

            <label class="control-label">英文文章内容（图片下）</label>
            <div class="controls">
              <textarea class="textarea_editor3 span12" name="content4" id="content2" rows="17" placeholder="输入文字..."><?php echo ($xl["content4"]); ?></textarea>
            </div>
