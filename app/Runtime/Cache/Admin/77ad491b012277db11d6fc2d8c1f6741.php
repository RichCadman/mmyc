...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">留言信息</a> </div>
    <h1>留言信息</h1>
  </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($news)): foreach($news as $k=>$v): ?><tr class="gradeX">
                  ...
                  <td><?php echo ($v["news_img1"]); ?></td>
                  <td><?php echo (msubstr($v["content1"],0,5,'utf-8',true)); ?></td>
                  <td><a href="/admin.php/News/update_news/id/<?php echo ($v["id"]); ?>">修改</a></td>
