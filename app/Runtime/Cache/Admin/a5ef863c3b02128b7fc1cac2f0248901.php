...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">上传体验图片</a> </div>
  <h1>上传体验图片</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Mmtm/update/id/<?php echo ($img["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">     
