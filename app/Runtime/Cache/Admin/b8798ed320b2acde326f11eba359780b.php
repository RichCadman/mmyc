...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">产品中心各系列图片</a> </div>
    <h1>产品中心各系列图片</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($xl)): foreach($xl as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  <td><?php echo ($v["title"]); ?></td>
                  <td><?php echo ($v["mmtm_img1"]); ?></td>
                  <td><?php echo ($v["mmtm_img2"]); ?></td>
                  <td><?php echo (msubstr($v["content1"],0,5,'utf-8',true)); ?></td>
                  <td><?php echo (msubstr($v["content2"],0,5,'utf-8',true)); ?></td>
                  <td><a href="/admin.php/Indexs/update_xilie/id/<?php echo ($v["id"]); ?>">修改</a></td>
