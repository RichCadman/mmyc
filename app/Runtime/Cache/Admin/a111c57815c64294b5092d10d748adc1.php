...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">方案</a> </div>
    <h1>方案</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($fangan)): foreach($fangan as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  <td><?php echo ($v["title"]); ?></td>
                  <td><?php echo ($v["img"]); ?></td>
                  <td><?php echo (msubstr($v["content"],0,5,'utf-8',true)); ?></td>
                  <td><a href="/admin.php/Fangan/update_fangan/id/<?php echo ($v["id"]); ?>">修改</a></td>
