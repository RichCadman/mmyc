...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">添加公司</a> </div>
  <h1>添加公司</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Company/update1/id/<?php echo ($company["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">     
            <div class="control-group">
              <label class="control-label">公司名称 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($company["company_name"]); ?>" name="company_name" id="company_name" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($company["address"]); ?>" name="address" id="address" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($company["tel"]); ?>" name="tel" id="tel"/>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($company["qq"]); ?>" name="qq" id="qq" />
              </div>
            </div>
