...
<head>
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" method="post" class="form-vertical" action="/admin.php/Login/login_do">
				 <div class="control-group normal_text"> <h3><img src="/pub/admin/img/logo.png" alt="Logo" /></h3></div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"></i></span><input type="text" name="admin_name" id="admin_name" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
