...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">顶端图片</a> </div>
    <h1>顶端图片</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($banner)): foreach($banner as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  <td><?php echo ($v["banner_img"]); ?></td>
                  <?php if($v['type']==1): ?><td>首页</td>
                  <?php elseif($v['type']==2): ?>
                     <td>产品中心</td>
                  <?php elseif($v['type']==3): ?>
                     <td>解决方案</td>
                  ...
                  <?php elseif($v['type']==6): ?>
                     <td>新闻中心</td>
                  <?php elseif($v['type']==7): ?>
                    <td>企业信息</td><?php endif; ?>
                  <td><a href="/admin.php/Indexs/update_banner/id/<?php echo ($v["id"]); ?>">修改</a></td>
