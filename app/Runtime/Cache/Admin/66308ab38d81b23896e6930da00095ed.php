        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($share)): foreach($share as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  <td><?php echo (msubstr($v["content"],0,80,'utf-8',true)); ?></td>
                  <td><a href="/admin.php/Company/mod_fenx/id/<?php echo ($v["id"]); ?>">修改</a></td>
