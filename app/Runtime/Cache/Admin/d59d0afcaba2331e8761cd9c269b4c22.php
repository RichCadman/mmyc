    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/News/add" method="post" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <div  data-date="" class="input-append date datepicker">
                <input type="text" value="" name="release_time" id="release_time" data-date-format="yyyy-mm-dd" class="span11" >
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <textarea class="textarea_editor span12" name="content1"  rows="7" placeholder="输入文字..."></textarea>
            </div>

            <label class="control-label">内容二</label>
            <div class="controls">
              <textarea class="textarea_editor2 span12" name="content2"  rows="7" placeholder="输入文字..."></textarea>
            </div>

            <label class="control-label">内容三</label>
            <div class="controls">
              <textarea class="textarea_editor3 span12" name="content3"  rows="7" placeholder="输入文字..."></textarea>
            </div>

            <label class="control-label">内容四</label>
            <div class="controls">
              <textarea class="textarea_editor4 span12" name="content4"  rows="7" placeholder="输入文字..."></textarea>
            </div>
