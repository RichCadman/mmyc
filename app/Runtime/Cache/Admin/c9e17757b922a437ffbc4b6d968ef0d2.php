...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">添加美鸣全国网络</a> </div>
  <h1>添加美鸣全国网络</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Company/update2/id/<?php echo ($network["id"]); ?>" method="post" class="form-horizontal">     
            <div class="control-group">
              <label class="control-label">公司名称 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($network["company"]); ?>" name="company" id="company"/>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($network["network"]); ?>"  name="network" id="network"/>
              </div>
            </div>
