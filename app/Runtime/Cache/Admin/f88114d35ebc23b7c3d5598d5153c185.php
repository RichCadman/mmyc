...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">添加新闻</a>  </div>
  <h1>添加新闻</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/News/update/id/<?php echo ($news["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="control-group">
            ...
            <label class="control-label">内容一</label>
            <div class="controls">
              <textarea class="textarea_editor span12" name="content1"  rows="7" placeholder="输入文字..."><?php echo ($news["content1"]); ?></textarea>
            </div>

            <label class="control-label">内容二</label>
            <div class="controls">
              <textarea class="textarea_editor2 span12" name="content2"  rows="7" placeholder="输入文字..."><?php echo ($news["content2"]); ?></textarea>
            </div>

            <label class="control-label">内容三</label>
            <div class="controls">
              <textarea class="textarea_editor3 span12" name="content3"  rows="7" placeholder="输入文字..."><?php echo ($news["content3"]); ?></textarea>
            </div>

            <label class="control-label">内容四</label>
            <div class="controls">
              <textarea class="textarea_editor4 span12" name="content4"  rows="7" placeholder="输入文字..."><?php echo ($news["content4"]); ?></textarea>
            </div>
